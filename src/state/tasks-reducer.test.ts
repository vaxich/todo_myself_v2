...
import { addTaskAC, changeTaskStatusAC, changeTaskTitleAC, removeTaskAC, tasksReducer } from "./tasks-reduer";
...
test('new property with new array should be added when new todolist is added', () => {
    ...
    const endState = tasksReducer(startState, addTodolistAC('no matter'))
